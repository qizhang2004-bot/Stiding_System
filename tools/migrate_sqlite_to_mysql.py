...
TABLES = [
    ...
    ("auth_user", ["id", "password", "last_login", "is_superuser", "username",
                   ...
                   "date_joined"], None),
    ("scheduler_group", ["id", "name", "short_name"], None),
    ("scheduler_role", ["id", "name"], None),
    ("scheduler_userprofile", ["id", "user_id", "group_id", "role"], None),
    ("scheduler_team", ["id", "group_id", "name", "daily_headcount", "shift_demand",
                        "role_reqs", "rest_block", "min_shift_target", "exempt_names"], None),
    ...
    ("scheduler_schedule", ["id", "team_id", "year", "month", "start_date", "days",
                            "shifts", "shift_demand", "daily_total", "role_reqs",
                            "min_shift_target", "exempt_names", "rest_block",
                            "worker_snapshot", "status", "message", "diagnostics",
                            "single_rest", "rest_run_violations", "created_at"], None),
